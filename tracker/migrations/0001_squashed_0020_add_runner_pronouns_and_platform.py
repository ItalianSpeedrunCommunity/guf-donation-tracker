    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(choices=[('USD', 'US Dollars'), ('CAD', 'Canadian Dollars'), ('EUR', 'Euro')], max_length=8, verbose_name='Currency')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paypalcurrency', models.CharField(choices=[('USD', 'US Dollars'), ('CAD', 'Canadian Dollars'), ('EUR', 'Euro')], default='EUR', max_length=8, verbose_name='Currency')),
        ...
        migrations.AddField(
            model_name='speedrun',
            name='category',
            field=models.CharField(blank=True, help_text='The type of run being performed', max_length=32, null=True),
        ),
        migrations.AddField(
            model_name='speedrun',
            name='release_year',
